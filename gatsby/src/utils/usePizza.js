...
const usePizza = ({pizzas, values}) => {
    ...
    // We got rid of this line because we moved useSte up to the provider
    // const [order, setOrder] = useState([]);
    // Now we access both our state and out updater function (setOrder) via content
